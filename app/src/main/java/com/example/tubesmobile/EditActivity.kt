...
class EditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.editTaskName.setText(countryData!!.countryName)
        binding.editSubjectName.setText(countryData.countryArea)
        binding.editTaskDeadline.setText((countryData.countryPopulation!!).toString());
        binding.editTaskDesc.setText(countryData.countryDescription)
